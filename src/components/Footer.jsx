...
const Footer = () => {
  return (
    <div className='w-full min-h-[40vh] bg-[#213A5A] text-white px-3 pt-7 relative'>
      <ul className='w-full h-full flex flex-wrap gap-x-4 gap-y-5 mobile:gap-x-16 laptop:gap-x-10 laptop:justify-center'>
        <li className='w-full mobile:w-[40%] laptop:w-[20%]'>
      ...
      <div className='w-full bg-[#ffffffbe] mt-8 text-[#213A5A] py-3 px-3 ipad:text-[15px] flex items-center '>&copy; Oladiipo Ayanlekan Ayomide 2023.</div>
    </div>
  )
}
