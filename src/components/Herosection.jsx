...
const Herosection = () => {
  return (
    <div className='w-full h-screen pt-28'>
      ...
      <div className='w-full flex items-center mt-5 justify-center px-5 mb-5'>
        <div className='w-full flex items-center justify-center rounded-3xl overflow-hidden px-3 bg-white gap-2 py-2'>
          <i className="fa-solid fa-magnifying-glass text-[#213A5A]"></i>
          <input type="text" className='w-full px-2 outline-none' placeholder='Search for your favorite Garri...' />
          <span className='material-symbols-outlined border p-2 rounded-full'>page_info</span>
        </div>
      </div>
