...
const Welcome = ({welcome}) => {
  return (
      <div className={`fixed left-0 transition-all ease duration-300 ${welcome ? 'top-[-120%]' : 'top-0'} w-full min-h-screen bg-[#E3EEFA] flex items-center justify-center flex-col z-[1111]`}>
